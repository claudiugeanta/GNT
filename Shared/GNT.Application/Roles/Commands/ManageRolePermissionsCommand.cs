...
namespace GNT.Administration.Application.Roles.Commands
{
    ...
    internal class ManageRolePermissionsCommandHandler(IAppDbContext appDbContext) : IRequestHandler<ManageRolePermissionsCommand, Unit>
    {
        public async Task<Unit> Handle(ManageRolePermissionsCommand request, CancellationToken cancellationToken)
        {
