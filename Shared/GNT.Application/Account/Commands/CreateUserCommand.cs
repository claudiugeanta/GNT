...
public class CreateUserCommandHandler(IAppDbContext appDbContext, ICurrentSession session, IEmailService emailService) : IRequestHandler<CreateUserCommand, Guid>
{
